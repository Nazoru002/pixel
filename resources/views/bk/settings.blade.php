        ...
        <div class="col-md-12 mb-4">
          ...
          <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{route('bk-settings')}}" method="POST" class="mb-4">
                    @csrf
                ...
                <form action="{{route('bk-settings-name')}}" method="POST">
                    @csrf
                    <div class="md-form">
                        <input type="text" name="nama_user" class="form-control" required value="{{Auth::user()->nama_user}}">
                    </div>
