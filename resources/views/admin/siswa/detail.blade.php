...
@section('content')
      ...
      <div class="row wow fadeIn">
        <div class="col-md-12 mb-4">
            <a class="btn btn-block btn-rounded btn-warning" href="{{route('admin-siswa-edit',$data->id)}}">Edit</a>
            <button class="btn btn-block btn-rounded btn-danger btn-delete" data-url="{{route('admin-siswa-delete',$data->id)}}">Hapus</button>
        </div>
      </div>
@endsection
@section('js_addon')
