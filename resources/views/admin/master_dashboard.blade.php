...
<head>
  ...
  <title>Admin Talent Mapping</title>
  <!-- Font Awesome -->
  ...
  <header>
    ...
    <div class="sidebar-fixed position-fixed">
      ...
      <div class="list-group list-group-flush">
        <a href="{{route('admin-index')}}" class="list-group-item {{(url()->current() == route('admin-index'))?'active':' list-group-item-action'}} waves-effect">
          <i class="fas fa-chart-pie mr-3"></i>Dashboard
        </a>
        <a href="{{route('admin-sekolah')}}" class="list-group-item {{(request()->segment(2) == 'sekolah')?'active':' list-group-item-action'}} waves-effect">
          <i class="fas fa-school mr-3"></i>Data Sekolah</a>
        <a href="{{route('admin-siswa')}}" class="list-group-item {{(request()->segment(2) == 'siswa')?'active':' list-group-item-action'}} waves-effect">
          <i class="fas fa-users mr-3"></i>Data Siswa</a>
        <a href="{{route('admin-settings')}}" class="list-group-item {{(request()->segment(2) == 'settings')?'active':' list-group-item-action'}} waves-effect">
          <i class="fas fa-cogs mr-3"></i>Pengaturan</a>
        <a href="{{route('admin-psc')}}" class="list-group-item {{(request()->segment(2) == 'psc')?'active':' list-group-item-action'}} waves-effect">
      ...
      <div class="card mb-4 wow fadeIn">
        ...
        <div class="card-body d-sm-flex justify-content-between">
          ...
          <h4 class="mb-2 mb-sm-0 pt-1">
            <a href="{{route('bk-index')}}" target="_blank">Administrator</a>
            <span>/</span>
            ...
            <div class="fixed-bottom w-100 pt-3 white text-center text-grey d-flex justify-content-center px-3">
                <div class="row">
                    <div class="col-md-2 col-4">
                        <a href="{{route('admin-index')}}" class="py-1 px-1 bot-nav-link">
                            <i class="fas fa-chart-pie fa-md"></i><br><p class="text-icon">Dashboard</p>
                        </a>
                    </div>
                    <div class="col-md-2 col-4">
                        <a href="{{route('admin-sekolah')}}" class="py-1 px-1 bot-nav-link">
                            <i class="fas fa-school fa-md"></i><br><p class="text-icon">Data Sekolah</p>
                        </a>
                    </div>
                    <div class="col-md-2 col-4">
                        <a href="{{route('admin-siswa')}}" class="py-1 px-1 bot-nav-link">
                            <i class="fas fa-users fa-md"></i><br><p class="text-icon">Data Siswa</p>
                        </a>
                    </div>
                    <div class="col-md-2 col-4">
                        <a href="{{route('admin-settings')}}" class="py-1 px-1 bot-nav-link">
                            <i class="fas fa-cogs fa-md"></i><br><p class="text-icon">Pengaturan</p>
                        </a>
                    </div>
                    <div class="col-md-2 col-4">
                        <a href="{{route('admin-psc')}}" class="py-1 px-1 bot-nav-link">
