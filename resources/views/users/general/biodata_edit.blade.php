...
@php
    ...
    $user = User::with('rdetsis')->where('id',Auth::id())->first();
@endphp
<div class="card panel p-3 mb-5">
    <div class="card-body">
        ...
        <form action="{{route('siswa-biodata-edit')}}" method="POST" class="form-biodata">
            @csrf
            ...
            <div class="form-group mb-5">
                ...
                <a href="{{route('siswa-biodata')}}" class="btn btn-block btn-rounded btn-danger"><b>Kembali</b></a>
            </div>
        </form>
    </div>
</div>
