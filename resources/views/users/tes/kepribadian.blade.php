...
<div class="card panel login-box p-3">
    <div class="card-body">
        ...
        @php
            ...
            $data = JawabanTesUser::where('id_user',Auth::user()->id)->where('type','kepribadian')->with('rkunci')->get();
        @endphp
        <div class="bold text-left">
            <ul>
                <li>Tujuan Tes : Tes ini diperuntukan untuk mengetahui kepribadian anda.</li>
        ...
        <div class="text-center bold">
            @if(count($data) < 1)
                <a href="{{route('siswa-tes-kepribadian-start')}}" class="btn btn-rounded btn-primary">Mulai</a>
            @endif
