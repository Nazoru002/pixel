...
<div class="card panel login-box p-3">
    <div class="card-body">
        ...
        @php
            ...
            $data = JawabanTesUser::where('id_user',Auth::user()->id)->where('type','numerik')->with('rkunci')->get();
        @endphp
        <div class="bold text-left">
            <ul>
                <li>Tujuan Tes : Tes ini diperuntukan untuk mengukur kemampuan anda dalam menghitung angka-angka.</li>
        ...
        <div class="text-center bold">
            @if(count($data) < 1)
                <a href="{{route('siswa-tes-numerik-start')}}" class="btn btn-rounded btn-primary">Mulai</a>
            @endif
